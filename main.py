...
def bot_response_function(user_message, chat_history):
    try:
        ...
        chatbot_prompt = f"""
        You are a phychologist who gives advice to kids in their life  
        ...
        * Ground all your answers based on this book {external_knowledge} and make sure you cite the exact phrase from that book
        ...
        try:
            image_prompt = f"A {response} in a modern art style"
        ...
        return "", chat_history, image if image else None
    except Exception as e:
        print(f"Error in bot_response_function: {e}")
...
if __name__ == "__main__":
    ...
    if args.option == 1:
        ...
        prompt = "write a 3 line post about the book sapiens by yuval harrari"
        ...
        prompt = "Create an image of a phycologist snake with spectacles in a modern art style"
        ...
        text_prompt = "write a 3 line post about the book sapiens by yuval harrari for instagram"
